...
/*
//x and y are the center points, r is the radius, n is the number of sides, t this the angle offset (theta)
...
//s is some scaling factor, t this the angle theta from North.
...
CanvasRenderingContext2D.prototype.roundRectQuad = function(x,y,w,h,r) {
    if (!Array.isArray(r)){
        r = Math.abs(r);
        r = Math.min(r,Math.min(w/2,h/2));
        r = [r,r,r,r];
...
function hex_map(dim)
{
	var map = [];
    let map_radius = dim - 1;
